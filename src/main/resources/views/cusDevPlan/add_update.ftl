...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input userName" lay-verify="required"
                   name="planItem"
                   id="planItem" value="${(cusDevPlan.planItem)!}" placeholder="请输⼊计划项内容">
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <#if (cusDevPlan.planDate)??>
                <input type="text" class="layui-input userName" lay-verify="required"
                       name="planDate"
                       id="planDate" placeholder="请输⼊计划项时间"
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        <label class="layui-form-label">执⾏效果</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input userEmail" lay-verify="required" name="exeAffect"
                   value="${(cusDevPlan.exeAffect)!}" id="exeAffect" placeholder="请输⼊执⾏效果">
        </div>
    </div>
    <br/>
    <div class="layui-form-item layui-row layui-col-xs12">
