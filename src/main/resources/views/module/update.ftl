...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input userName"
                   name="moduleStyle" id="moduleStyle" value="${(module.moduleStyle)!""}"
                   placeholder="请输⼊菜单样式">
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input userName"
                   lay-verify="required" name="optValue" id="optValue" placeholder="请输⼊菜单权
限码" value="${module.optValue}">
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <select name="grade" >
                <option value="0" <#if module.grade==0>selected="selected"</#if>>⼀级菜单</option>
                <option value="1" <#if module.grade==1>selected="selected"</#if>>⼆级菜单</option>
